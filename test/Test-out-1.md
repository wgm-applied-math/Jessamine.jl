...
Test to_expr
cg.expr = quote
    #= /home/garrett/git/Research/Jessamine.jl/src/GenomeCore.jl:238 =#
    function (cs::CellState{E},) where E
        #= /home/garrett/git/Research/Jessamine.jl/src/GenomeCore.jl:238 =#
        #= /home/garrett/git/Research/Jessamine.jl/src/GenomeCore.jl:239 =#
        new_output = E[.+(cs.parameter[1], cs.scratch[1], cs.input[2]), cs.parameter[3] .* cs.input[1]]
        #= /home/garrett/git/Research/Jessamine.jl/src/GenomeCore.jl:241 =#
        new_scratch = E[.*(cs.parameter[2], cs.input[1], cs.input[1])]
        #= /home/garrett/git/Research/Jessamine.jl/src/GenomeCore.jl:243 =#
...
(compile(g_spec, genome_min_max)).expr = quote
    ...
    function (cs::CellState{E},) where E
        #= /home/garrett/git/Research/Jessamine.jl/src/GenomeCore.jl:238 =#
        #= /home/garrett/git/Research/Jessamine.jl/src/GenomeCore.jl:239 =#
        new_output = E[.+((#= /home/garrett/git/Research/Jessamine.jl/src/Operations.jl:500 =#
                        min.(cs.output[1], cs.output[2])), cs.parameter[2], [Inf]), .+((#= /home/garrett/git/Research/Jessamine.jl/src/Operations.jl:469 =#
...
pop_init =
slot 1:
rating = 196.22805870614906
1 = sum [ mul 6 7 3, ]
2 = sum [ mul 1 7 2, ]
3 = sum [ mul 7, ]
4 = sum [ mul 3 6, ]
parameter = [0.0]
extra = Jessamine.BasicLinearModelResult([0.17949381295457623, 0.0, 2.874683225809554, -3.3262181864669134], 0.0)

slot 2:
rating = 230.46393780436858
1 = sum [ mul 7, ]
2 = sum [ mul 3 5, ]
3 = sum [ mul 7, ]
4 = sum [ mul 6 7, ]
parameter = [0.025]
extra = Jessamine.BasicLinearModelResult([1.3722926301684775, 0.03430732262815495, 1.3722926527637678, -3.4615370197750424], 0.0)

slot 3:
rating = 768.5251020992799
1 = sum [ mul 5 6, ]
2 = sum [ mul 5, ]
3 = sum [ mul 2, ]
4 = sum [ mul 7, ]
parameter = [2.223437500000001]
extra = Jessamine.BasicLinearModelResult([2.0427532966138506, 0.678506509742096, 0.6785065062217581, 4.0335909271713835], 0.0)

slot 4:
rating = 783.8787814632733
1 = sum [ mul 7 6, ]
2 = sum [ mul 1, ]
3 = sum [ mul 1 7, ]
4 = sum [ mul 2 3, ]
parameter = [0.0]
extra = Jessamine.BasicLinearModelResult([-1.313803607250305, -1.3138036026706454, 0.21362693447306325, 0.2114960207950696], 0.0)

slot 5:
rating = 834.942756997858
1 = sum [ mul 6 7 6, ]
2 = sum [ mul 3, ]
3 = sum [ mul 1, ]
4 = sum [ mul 7, ]
parameter = [0.0]
extra = Jessamine.BasicLinearModelResult([0.5085880963717524, 0.5085880828538168, 0.5085880634348, 2.7329836589794576], 0.0)

slot 6:
rating = 961.9553513423054
1 = sum [ mul 5 3 2, ]
2 = sum [ mul 3 3 2, ]
3 = sum [ mul 4 6, ]
4 = sum [ mul 7 6, ]
parameter = [0.0]
extra = Jessamine.BasicLinearModelResult([0.0, 0.0, 1.123620001336205, -3.381216936921633], 0.0)

slot 7:
rating = 994.8098906623499
1 = sum [ mul 5 6, ]
2 = sum [ mul 3 5 3, ]
3 = sum [ mul 7 2, ]
4 = sum [ mul 7 5, ]
parameter = [2.265625]
extra = Jessamine.BasicLinearModelResult([1.469768896847263, 0.0, 0.0, 1.7360091210971673], 0.0)

slot 8:
rating = 1160.8889474369662
1 = sum [ mul 7 6 4, ]
2 = sum [ mul 1, ]
3 = sum [ mul 5 4 4, ]
4 = sum [ mul 5, ]
parameter = [1.8015625000000008]
extra = Jessamine.BasicLinearModelResult([-1.2914326902533186, -1.2914326718053526, 0.03665736116181512, 0.011294354700939688], 0.0)

slot 9:
rating = 1286.0128694902426
1 = sum [ mul 5 4, ]
2 = sum [ mul 7, ]
3 = sum [ mul 2, ]
4 = sum [ mul 7 5 7, ]
parameter = [0.4375000000000001]
extra = Jessamine.BasicLinearModelResult([0.1415937142002755, 1.9224291856847746, 1.9224291814110308, 0.3236426862498506], 0.0)
...
rng = Xoshiro(0x57151948a96bdfed, 0x960264403be6ab49, 0x889e29b5c8564ae9, 0x8fbde859af963952, 0xcf19a1f021e48577)

Before pop_next
rng = Xoshiro(0x57151948a96bdfed, 0x960264403be6ab49, 0x889e29b5c8564ae9, 0x8fbde859af963952, 0xcf19a1f021e48577)
Generation 10, best = 1.87117717956518e-5
Generation 20, best = 1.7230068978463176e-5
Generation 30, best = 1.461381432881097e-5
Generation 40, best = 1.358686505506258e-5
Generation 50, best = 1.358686505506258e-5
Generation 60, best = 1.358686505506258e-5
Generation 70, best = 1.358686505506258e-5
Generation 80, best = 1.358686505506258e-5
Generation 90, best = 1.358686505506258e-5
Generation 100, best = 1.358686505506258e-5
pop_next =
slot 1:
rating = 1.358686505506258e-5
1 = sum [ mul 5 5, ]
2 = sum [ mul 4 3, ]
3 = sum [ mul 7, mul 4, mul 3, ]
4 = sum [ mul 6 1, ]
parameter = [1.5062500000000005]
extra = Jessamine.BasicLinearModelResult([0.881527513634425, -0.6611456417850732, 0.99999999906515, 0.3222912781502665], 0.0)
...
rng = Xoshiro(0x324e7567ead9a063, 0x3a59c6ca3f68f2f5, 0x7b04ae2219f3e733, 0x0a486beea67a9d0e, 0xcf19a1f021e48577)
...
parameter = [1.5062500000000005]
extra = Jessamine.BasicLinearModelResult([0.881527513634425, -0.6611456417850732, 0.99999999906515, 0.3222912781502665], 0.0)
basic_sym_res.y_sym = b₀ + b₁*(p₁^2) + b₃*(3x₂ + (p₁^2)*x₁) + b₄*(p₁^2)*x₁ + 2b₂*(p₁^2)*x₁*x₂
basic_sym_res.y_num = 1.9999999812266045 + 0.99999999906515(2.2687890625000016x₁ + 3x₂) + 0.7312109268064704x₁ - 3.000000001603036x₁*x₂
sym_res.y_sym = b₀ + b₁*(p₁^2) + b₃*(3x₂ + (p₁^2)*x₁) + b₄*(p₁^2)*x₁ + 2b₂*(p₁^2)*x₁*x₂
a_best.parameter = [1.5062500000000005]
a_best.extra = Jessamine.BasicLinearModelResult([0.881527513634425, -0.6611456417850732, 0.99999999906515, 0.3222912781502665], 0.0)
sym_res.y_num = 1.9999999812266045 + 0.99999999906515(2.2687890625000016x₁ + 3x₂) + 0.7312109268064704x₁ - 3.000000001603036x₁*x₂
y_num = 1.9999999812266045 + 2.999999987185494x₁ + 2.99999999719545x₂ - 3.000000001603036x₁*x₂
cvec = [1.9999999812266045, 2.999999987185494, 2.99999999719545, -3.000000001603036]
...
parameter = [1.5062500000000005]
extra = Jessamine.BasicLinearModelResult([0.881527513634425, -0.6611456417850732, 0.99999999906515, 0.3222912781502665], 0.0)
basic_sympy_res.y_sym = b0 + b1*p1^2 + 2*b2*p1^2*x1*x2 + b3*(p1^2*x1 + 3*x2) + b4*p1^2*x1
basic_sympy_res.y_num = -3.00000000160304*x1*x2 + 2.99999998718549*x1 + 2.99999999719545*x2 + 1.9999999812266
sympy_res.y_sym = b0 + b1*p1^2 + 2*b2*p1^2*x1*x2 + b3*(p1^2*x1 + 3*x2) + b4*p1^2*x1
sympy_res.y_num = -3.00000000160304*x1*x2 + 2.99999998718549*x1 + 2.99999999719545*x2 + 1.9999999812266
rng = Xoshiro(0x324e7567ead9a063, 0x3a59c6ca3f68f2f5, 0x7b04ae2219f3e733, 0x0a486beea67a9d0e, 0xcf19a1f021e48577)
...
Before pop_next
rng = Xoshiro(0x8d5c24a5edda71c1, 0x21a21c721ec865fc, 0x88c40b7833e28795, 0xbfc4364feed385ce, 0xcf19a1f021e48577)
Generation 10, best = 2.1591763929622994e-5
Generation 20, best = 1.6460831958776496e-5
Generation 30, best = 1.551581936023338e-5
Generation 40, best = 1.3641925205432633e-5
Generation 50, best = 1.3401378246168749e-5
Generation 60, best = 1.3401378246168749e-5
Generation 70, best = 1.314062877328546e-5
...
extra = Jessamine.BasicLinearModelResult([0.6383763943967038, 0.4255842626214184, -0.13584147441211855, 0.6383763956525583], 0.0)
...
rng = Xoshiro(0xc7b9f3eaf12179d0, 0xd179cfb217fbe1c3, 0x4859c2be9d4a21a4, 0x84c104ea17d02e98, 0xcf19a1f021e48577)
...
basic_sym_res.y_num = 1.999999993418841 + 2.999999992311501x₁ + 2.9999999982132914x₂ - 3.0000000016532926x₁*x₂
sym_res.y_sym = b₀ + b₂*(p₁^3) + b₁*(p₁^3)*x₁ + b₄*(p₁^3)*x₂ + b₃*(p₁^6)*x₁*x₂
a_best.parameter = [1.6750000000000007]
a_best.extra = Jessamine.BasicLinearModelResult([0.6383763943967038, 0.4255842626214184, -0.13584147441211855, 0.6383763956525583], 0.0)
sym_res.y_num = 1.999999993418841 + 2.999999992311501x₁ + 2.9999999982132914x₂ - 3.0000000016532926x₁*x₂
y_num = 1.999999993418841 + 2.999999992311501x₁ + 2.9999999982132914x₂ - 3.0000000016532926x₁*x₂
cvec = [1.999999993418841, 2.999999992311501, 2.9999999982132914, -3.0000000016532926]
round.(cvec) = [2.0, 3.0, 3.0, -3.0]
rating = 1.2820248716083718e-5
1 = sum [ mul 6 2, ]
2 = sum [ mul 5 5 5, ]
...
parameter = [1.6750000000000007]
extra = Jessamine.BasicLinearModelResult([0.6383763943967038, 0.4255842626214184, -0.13584147441211855, 0.6383763956525583], 0.0)
basic_sympy_res.y_sym = b0 + b1*p1^3*x1 + b2*p1^3 + b3*p1^6*x1*x2 + b4*p1^3*x2
basic_sympy_res.y_num = -3.00000000165329*x1*x2 + 2.9999999923115*x1 + 2.99999999821329*x2 + 1.99999999341884
sympy_res.y_sym = b0 + b1*p1^3*x1 + b2*p1^3 + b3*p1^6*x1*x2 + b4*p1^3*x2
